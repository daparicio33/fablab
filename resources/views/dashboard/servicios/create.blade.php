...
@section('content_header')
    ...
    <p>
        <small>
            recuerde completar todos los campos para registrar el servicio.
        </small>
    </p>
@stop
@section('content')
{!! Form::open(['route'=>'dashboard.servicios.store','method'=>'post','id'=>'frm','enctype'=>'multipart/form-data']) !!}
   <div class="row">
